...
// Hash: gloas_state_minimal (with preset modifications)
...
// Minimal preset constants for BeaconStateGloas:
...
func (b *BeaconStateGloas) UnmarshalSSZ(buf []byte) error {
	...
	if err = b.LatestExecutionPayloadBid.UnmarshalSSZ(buf[10229:10449]); err != nil {
		return err
	}

	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = ssz.UnmarshallUint64(buf[10449:10457])

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = github_com_OffchainLabs_prysm_v7_consensus_types_primitives.ValidatorIndex(ssz.UnmarshallUint64(buf[10457:10465]))

	// Offset (27) 'HistoricalSummaries'
	if o27 = ssz.ReadOffset(buf[10465:10469]); o27 > size || o21 > o27 {
		return ssz.ErrOffset
	}

	// Field (28) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[10469:10477])

	// Field (29) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[10477:10485]))

	// Field (30) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[10485:10493]))

	// Field (31) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[10493:10501]))

	// Field (32) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[10501:10509]))

	// Field (33) 'EarliestConsolidationEpoch'
	b.EarliestConsolidationEpoch = github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[10509:10517]))

	// Offset (34) 'PendingDeposits'
	if o34 = ssz.ReadOffset(buf[10517:10521]); o34 > size || o27 > o34 {
		return ssz.ErrOffset
	}

	// Offset (35) 'PendingPartialWithdrawals'
	if o35 = ssz.ReadOffset(buf[10521:10525]); o35 > size || o34 > o35 {
		return ssz.ErrOffset
	}

	// Offset (36) 'PendingConsolidations'
	if o36 = ssz.ReadOffset(buf[10525:10529]); o36 > size || o35 > o36 {
		return ssz.ErrOffset
	}

	// Field (37) 'ProposerLookahead' - minimal: 16 elements (mainnet: 64)
	b.ProposerLookahead = ssz.ExtendUint64(b.ProposerLookahead, 16)
	for ii := 0; ii < 16; ii++ {
		b.ProposerLookahead[ii] = ssz.UnmarshallUint64(buf[10529:10657][ii*8 : (ii+1)*8])
	}

	// Offset (38) 'Builders'
	if o38 = ssz.ReadOffset(buf[10657:10661]); o38 > size || o36 > o38 {
		return ssz.ErrOffset
	}

	// Field (39) 'NextWithdrawalBuilderIndex'
	b.NextWithdrawalBuilderIndex = github_com_OffchainLabs_prysm_v7_consensus_types_primitives.BuilderIndex(ssz.UnmarshallUint64(buf[10661:10669]))

	// Field (40) 'ExecutionPayloadAvailability'
	if cap(b.ExecutionPayloadAvailability) == 0 {
		b.ExecutionPayloadAvailability = make([]byte, 0, len(buf[10669:11693]))
	}
	b.ExecutionPayloadAvailability = append(b.ExecutionPayloadAvailability, buf[10669:11693]...)
	...
	for ii := 0; ii < 64; ii++ {
		...
		if err = b.BuilderPendingPayments[ii].UnmarshalSSZ(buf[11693:14509][ii*44 : (ii+1)*44]); err != nil {
			return err
		}
	}

	// Offset (42) 'BuilderPendingWithdrawals'
	if o42 = ssz.ReadOffset(buf[14509:14513]); o42 > size || o38 > o42 {
		return ssz.ErrOffset
	}

	// Field (43) 'LatestBlockHash'
	if cap(b.LatestBlockHash) == 0 {
		b.LatestBlockHash = make([]byte, 0, len(buf[14513:14545]))
	}
	b.LatestBlockHash = append(b.LatestBlockHash, buf[14513:14545]...)

	// Offset (44) 'PayloadExpectedWithdrawals'
	if o44 = ssz.ReadOffset(buf[14545:14549]); o44 > size || o42 > o44 {
		return ssz.ErrOffset
	}
