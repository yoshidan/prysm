...
// Minimal preset constants for BeaconStateFulu:
...
func (b *BeaconStateFulu) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(b.BlockRoots); size != 64 {
		err = ssz.ErrVectorLengthFn("--.BlockRoots", size, 64)
		return
	}
	for ii := 0; ii < 64; ii++ {
...
func (b *BeaconStateFulu) UnmarshalSSZ(buf []byte) error {
	...
	// Field (5) 'BlockRoots' - minimal: 64 * 32 = 2048 bytes
	...
	// Field (6) 'StateRoots' - minimal: 64 * 32 = 2048 bytes
	...
	// Field (13) 'RandaoMixes' - minimal: 64 * 32 = 2048 bytes
	...
	// Field (14) 'Slashings' - minimal: 64 * 8 = 512 bytes
	...
	// Field (22) 'CurrentSyncCommittee' - minimal: 32*48+48 = 1584 bytes
	if b.CurrentSyncCommittee == nil {
		b.CurrentSyncCommittee = new(SyncCommittee)
	}
	...
	// Field (23) 'NextSyncCommittee' - minimal: 1584 bytes
	if b.NextSyncCommittee == nil {
		b.NextSyncCommittee = new(SyncCommittee)
	}
	...
	// Field (28) 'DepositRequestsStartIndex'
	b.DepositRequestsStartIndex = ssz.UnmarshallUint64(buf[10253:10261])

	// Field (29) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[10261:10269]))

	// Field (30) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[10269:10277]))

	// Field (31) 'EarliestExitEpoch'
	b.EarliestExitEpoch = github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[10277:10285]))

	// Field (32) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Gwei(ssz.UnmarshallUint64(buf[10285:10293]))

	// Field (33) 'EarliestConsolidationEpoch'
	b.EarliestConsolidationEpoch = github_com_OffchainLabs_prysm_v7_consensus_types_primitives.Epoch(ssz.UnmarshallUint64(buf[10293:10301]))

	// Offset (34) 'PendingDeposits'
	if o34 = ssz.ReadOffset(buf[10301:10305]); o34 > size || o27 > o34 {
		return ssz.ErrOffset
	}

	// Offset (35) 'PendingPartialWithdrawals'
	if o35 = ssz.ReadOffset(buf[10305:10309]); o35 > size || o34 > o35 {
		return ssz.ErrOffset
	}

	// Offset (36) 'PendingConsolidations'
	if o36 = ssz.ReadOffset(buf[10309:10313]); o36 > size || o35 > o36 {
		return ssz.ErrOffset
	}
	...
	for ii := 0; ii < 16; ii++ {
		b.ProposerLookahead[ii] = ssz.UnmarshallUint64(buf[10313:10441][ii*8 : (ii+1)*8])
	}
